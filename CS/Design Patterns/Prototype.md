...
public static void main(String[] args) throws CloneNotSupportedException {  
	...
	// field1 is an int literal. If we don't change it, cloneableTestClass1.field1 and cloneableTestClass2.field1 have the same memory address.
cloneableTestClass1.field1 = 5;
	// But if we change one, they no longer share the same objects.  
